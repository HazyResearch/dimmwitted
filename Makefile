...
CPP_FLAG = -O3 -mavx -std=c++11 -I./lib/libunwind-1.1/include -L./lib/numactl-2.0.9 -I./lib/numactl-2.0.9
...
exp: examples/example.cpp examples/logistic_regression_dense_sgd.cpp
